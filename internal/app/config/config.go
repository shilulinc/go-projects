...
func init() {
	...
	log.Printf("THE SERVER RUNMODE: %s, configFile: conf_%s.ini \n", RUNMODE, RUNMODE)

	Conf, err = goconfig.LoadConfigFile(configFilePre + RUNMODE + ".ini")
...
type IdConfig struct {
	// ID 长度
	IdLength int `json:"idLength" format:"int" example:"5"`
